...
; Return type is void 
mergeSort:
	cmp rsi, rdx 		; compare L and R
	jge done		; if L >= R, return
	mov r9, rsi		; r9 = L
	add r9, rdx		; r9 += R
	sar r9, 1		; r9 = r9/2
	push rsi		; push L to stack
	push r9			; push mid to stack
	push rdx		; push R to stack
	mov rdx, r9		; rdx = mid
	call mergeSort
	...
	push rsi		; push new R
	push rdx		; push new L
	mov rsi, r9		; rsi = mid + 1
	call mergeSort
	
	pop rcx			; pop R -> param 4 of merge
	pop rsi			; pop mid -> param 3 of merge
	pop rdx			; pop L -> param 2 of merge
	call merge
done:
	ret
